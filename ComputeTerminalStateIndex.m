...
global DROP_OFF
[M,N]=size(map);
[delivery_m,delivery_n]=find(map==DROP_OFF);
%make sure [delivery_m,delivery_n,1] is the memeber of the state matrix 
ind=ismember(stateSpace,[delivery_m,delivery_n,1],'rows');
stateIndex=find(ind==1);
